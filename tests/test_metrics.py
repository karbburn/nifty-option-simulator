...
def _trades() -> pd.DataFrame:
    return pd.DataFrame(
        [
            ...
            ["2026-08-11", "2026-08-12", "Mon→Tue", "CE", 24500, 24500, "2026-08-13", 100.0, 50.0, "stop_5", 1, -50.0],
...
def test_trade_stats_hand_computed():
    ...
    assert by_reason["stop_5"]["count"] == 1 and by_reason["stop_5"]["pct"] == pytest.approx(25.0)
